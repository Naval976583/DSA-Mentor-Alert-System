...
A Flask-based web application that monitors Coding Ninjas mentor dashboard for new doubts and sends SMS notifications via Twilio when doubts are available during specified time windows.
...
```bash
git clone https://github.com/Naval976583/DSA-Mentor-Alert-System.git
cd DSA-Mentor-Alert-System
```
...
2. Add ChromeDriver to your PATH or specify its location in the code

** Twilio SMS not working:

1. Verify your Twilio credentials are correct

2. Check your Twilio account has sufficient balance

3. Ensure the recipient number is verified (for trial accounts)

** Login issues:

1. Double-check your Coding Ninjas credentials

2. Ensure you're using the correct OTP

** Security Notes
1. Never commit your .env file to version control

2. Keep your Twilio credentials secret

3. The application stores session information in memory only
